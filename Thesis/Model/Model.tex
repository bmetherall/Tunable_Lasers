...
We shall start our analysis with the derivation of the functional operators for the five components. \\
...
\end{align}
where $g(A)$ takes the form \cite{bohun, burgoyne2014, hausbook, haus1975, haus1991, haus1992, haus2000, peng, shtyrina, silfvast, usechak, yarutkina}
\begin{align}
\label{eq:energy}
...
\end{align*}
this is also frequently called the Kerr nonlinearity or Kerr effect after John Kerr who discovered it in 1875. As we shall see in Section \ref{chap:energy}, this is what is responsible for self-phase modulation and ultimately the degradation of the pulse \cite{desurvire, dunlop, martinez1984, tamura}.
...
In the average model, the amount of modulation is characterized by the parameter $M_s$ through the term $\frac{M_s}{2}T^2 A$. In this new model, the modulation is considered to be applied externally through its action on the spectrum and for simplicity the representation is taken as the Gaussian
\begin{align*}
...
\end{align}
The asymptotic expansions of the variance in the case of $s \rightarrow 0$, and $s \rightarrow \infty$ are derived in Appendix \ref{chap:asymp}. \\
