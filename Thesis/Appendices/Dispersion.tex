...
The effect of dispersion can be computed analytically for several input pulses using \eqref{eq:disp}. In the case of a Gaussian pulse, we make use of the transforms \cite{gradshteyn}
\begin{align*}
...
The expressions for the chirp and variance can be verified with the well known relations \cite{agrawal2013, ferreira, silfvast}
\begin{align*}
