...
% Circulators
\filldraw[fill=white, draw=black] (6,2) circle (0.5cm) node [anchor=west,xshift=0.5cm,align=center] {Optical \\ Circulator};
...
\draw [->,>=stealth,domain=110:160] plot ({6+0.675*cos(\x)}, {2+0.675*sin(\x)});
\draw [->,>=stealth,domain=200:250] plot ({6+0.675*cos(\x)}, {2+0.675*sin(\x)});
