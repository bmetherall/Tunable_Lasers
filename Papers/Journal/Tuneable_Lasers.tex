...
\end{align}
for \eqref{eq:A0} to be in equilibrium. Manipulating \eqref{eq:sigrelation} and \eqref{eq:chirprelation} we acquire the simpler relations
\begin{gather}
	...
	\label{eq:chirp}
\end{gather}
The equilibrium energy can be found from \eqref{eq:energyrelation}, using the properties of the Lambert $W$ function, giving
\begin{align}
...
\eqref{eq:var} has an analytic solution, as it is a quartic in $\sigma^2$. Namely,
\begin{equation}
	\begin{split}
