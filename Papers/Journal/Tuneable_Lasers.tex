...
\begin{align}
	...
	\label{eq:var}
\end{align}
which contains $\sigma^2$ terms only. As \eqref{eq:var} is a quartic in $\sigma^2$, it has an analytic solution, namely,
\begin{equation}
	\begin{split}
